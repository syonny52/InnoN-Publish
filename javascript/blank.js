(function ($) {
    ...
    $(function () {
        ...
        if ($("#serviceSaleProgress").length) {
            ...
            let linearGradient = '<defs><linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="0%" gradient' +
                    'Units="userSpaceOnUse"><stop offset="20%" stop-color="#da8cff"/><stop offset="' +
                    '50%" stop-color="#9a55ff"/></linearGradient></defs>';
            bar
                .svg
                .insertAdjacentHTML('afterBegin', linearGradient);
        }
        if ($("#productSaleProgress").length) {
            ...
            bar.path.style.strokeLinecap = 'round';
            let linearGradient = '<defs><linearGradient id="productGradient" x1="0%" y1="0%" x2="100%" y2="0%" g' +
                    'radientUnits="userSpaceOnUse"><stop offset="40%" stop-color="#36d7e8"/><stop o' +
                    'ffset="70%" stop-color="#b194fa"/></linearGradient></defs>';
            bar
                .svg
                .insertAdjacentHTML('afterBegin', linearGradient);
        }
        ...
        if ($("#inline-datepicker").length) {
            $('#inline-datepicker').datepicker(
                {enableOnReadonly: true, todayHighlight: true}
            );
        }
    });
})(jQuery);