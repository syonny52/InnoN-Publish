/* ! Chart.js v2.8.0 https://www.chartjs.org (c) 2019 Chart.js Contributors
...
!function (t, e) {
    ...
    function p(t) {
        ...
        e = (e = 3.2406 * a + -1.5372 * o + -.4986 * r) > .0031308
    ...
    var Z = {
            ...
            easeInOutBounce: function (t) {
                return t < .5
                    ? .5 * Z.easeInBounce(2 * t)
                    : .5 * Z.easeOutBounce(2 * t - 1) + .5
            }
        },
        $ = {
            effects: Z
            ...
            _parseFont: function (t) {
                var e = st.global,
                    ...
                    n = {
                        ...
                        lineHeight: G
                            .options
                            .toLineHeight(lt(t.lineHeight, e.defaultLineHeight), i),
                        size: i,
    ...
    ut.extend(gt.prototype, {
        ...
        transition: function (t) {
            var e = this,
                ...
                a = e._view;
            return i && 1 !== t
                ? (a || (a = e._view = {}), n || (n = e._start = {}), function (t, e, i, n) {
                    var a,
                        o,
                        r,
                        s,
    ...
    ut.extend(wt.prototype, {
        ...
        buildOrUpdateElements: function () {
            var t,
                ...
                n = i.getDataset(),
                a = n.data || (n.data = []);
            i._data !== a && (i._data && kt(i._data, i), a && Object.isExtensible(a) && (
                e = i,
                (t = a)._chartjs
    ...
    var Tt = pt.extend({
            inRange: function (t, e) {
                var i = this._view;
                return !!i && Math.pow(t - i.x, 2) + Math.pow(e - i.y, 2) < Math.pow(
                    i.hitRadius + i.radius,
                    2
                )
            },
            inLabelRange: Dt,
            ...
            draw: function (t) {
                var e = this._view,
                    ...
                    l = st.global,
                    d = l.defaultColor;
                e.skip || (void 0 === t || ut.canvas._isPointInArea(e, t)) && (
    ...
    var Yt = Mt.extend({
            ...
            calculateBarValuePixels: function (t, e) {
                ...
                if (p || void 0 === p && void 0 !== m) 
                    for (i = 0; i < t; ++i) 
                        (n = l.getDatasetMeta(i)).bar && n.stack === m && n
                            .controller
                            ._getValueScaleId() === u.id && l.isDatasetVisible(i) && (
    ...
    var $t = Mt.extend({
        ...
        getMaxBorderWidth: function (t) {
            ...
            for (e = 0, i = t.length; e < i; ++e) 
                ...
                "inner" !== (
                    r = o
                        ? o._resolveElementOptions(a, e)
                        : a._options
                ).borderAlign && (
                    s = r.borderWidth,
                    d = (l = r.hoverBorderWidth) > (
                            d = s > d
                                ? s
                                : d
                        )
    ...
    var ne = Mt.extend({
            ...
            updateBezierControlPoints: function () {
                ...
                if (
                    r.spanGaps && (l = l.filter(function (t) {
            ...
            if (a.options.elements.line.capBezierPoints) 
                    for (t = 0, e = l.length; t < e; ++t) 
                        ...
                        ), t < l.length - 1 && ee(l[t + 1]._model, s) && (
            ...
            draw: function () {
                var t,
                    ...
                    r = 0;
                for (
                    ie(this.getDataset(), e.options) && (t = (i.dataset._model.borderWidth || 0) / 2, ut.canvas.clipArea(e.ctx, {
                        left: a.left,
                        right: a.right,
                        top: a.top - t,
                        bottom: a.bottom + t
            ...
            ut.extend(t, {
                ...
                _model: {
                    ...
                    outerRadius: i
                        ? m
                        : f,
                    startAngle: i && s.animateRotate
                        ? c
                        : g,
                    endAngle: i && s.animateRotate
                        ? c
                        : p,
        ...
        var n,
            ...
            l = s.resizer = function (t) {
                ...
                r = Array
                    ...
                    .call(arguments),
                a = a || this,
                o || (o = !0, ut.requestAnimFrame.call(window, function () {
                    o = !1,
                    n.apply(a, r)
                }))
            }));
    ...
    var Ne = {
        ...
        _ensureLoaded: function () {
            ...
            this._loaded || (
                this._loaded = !0,
                this.disableCSSInjection || (e = Me, i = (t = this)._style || document.createElement("style"), t._style || (
                    t._style = i,
                    e = "/* Chart.js */\n" + e,
    ...
    var Ee = {
        ...
        He = {
            ...
            updateScaleDefaults: function (t, e) {
                this
                    .defaults
                    .hasOwnProperty(t) && (this.defaults[t] = ut.extend(this.defaults[t], e))
            },
    ...
    var Ze = pt.extend({
                ...
                if (p.length) {
                    ...
                    for (e = 0, i = p.length; e < i; ++e) 
                        M.push((
                            ...
                            {
                                xLabel: a
                                    ? a.getLabelForIndex(r, s)
                                    : "",
                                yLabel: o
                                    ? o.getLabelForIndex(r, s)
                                    : "",
                                label: d
                                    ? "" + d.getLabelForIndex(r, s)
                                    : "",
                                value: u
                                    ? "" + u.getLabelForIndex(r, s)
                                    : "",
                                index: r,
                                datasetIndex: s,
                                x: n._model.x,
            ...
            handleEvent: function (t) {
                ...
                "mouseout" === t.type
                    ...
                    : i._active = i
                        ._chart
                        .getElementsAtEventForMode(t, n.mode, n),
    ...
    ut.extend(ni.prototype, {
        ...
        resize: function (t) {
            var e = this,
                ...
                r = Math.max(0, Math.floor(
                    a
                        ? o / a
                        : ut.getMaximumHeight(n)
                ));
            if ((e.width !== o || e.height !== r) && (
                n.width = e.width = o,
                n.height = e.height = r,
                n.style.width = o + "px",
                n.style.height = r + "px",
        ...
        update: function (t) {
            ...
            if (
                ...
                n.updateLayout(),
                n.options.animation && n.options.animation.duration && ut.each(
                    a,
                    function (t) {
                        t.reset()
                    }
        ...
        draw: function (t) {
            ...
            e.transition(t),
            e.width <= 0 || e.height <= 0 || !1 !== Ee.notify(e, "beforeDraw", [t]) && (
                ut.each(e.boxes, function (t) {
                    t.draw(e.chartArea)
                }, e),
                e.drawDatasets(t),
                e._drawTooltip(t),
        ...
        updateHoverStyle: function (t, e, i) {
            ...
            for (a = 0, o = t.length; a < o; ++a) 
                (n = t[a]) && this
                    .getDatasetMeta(n._datasetIndex)
                    .controller[r](n)
            },
        ...
        handleEvent: function (t) {
            ...
            ut.callback(n.onHover || n.hover.onHover, [
                t.native, i.active
            ], i),
            "mouseup" !== t.type && "click" !== t.type || n.onClick && n
                .onClick
                .call(i, t.native, i.active),
    ...
    var fi = pt.extend({
            ...
            afterBuildTicks: function (t) {
                ...
                return ut.isArray(t) && t.length
                    ...
                    : (
                        e.ticks = ut.callback(e.options.afterBuildTicks, [e, e.ticks]) || e.ticks,
                        t
                    )
            },
            ...
            getPixelForTick: function (t) {
                var e = this,
                    i = e.options.offset;
                if (e.isHorizontal()) {
                    var n = (e.width - (e.paddingLeft + e.paddingRight)) / Math.max(
                            e._ticks.length - (
                                i
                                    ? 0
                                    : 1
        ...
        gi = fi.extend({
            ...
            getPixelForValue: function (t, e) {
                var i,
                    n = this,
                    a = n.options.offset,
                    o = Math.max(n.maxIndex + 1 - n.minIndex - (
                        a
                            ? 0
                            : 1
                    ), 1);
                ...
                if (void 0 === r && ut.each(n, function (t, e) {
                    ...
                    ut.each(n, function (n, a) {
                        var r = i.getDatasetMeta(a),
                            l = [
                                r.type, void 0 === e.stacked && void 0 === r.stack
                                    ? a
                                    : "",
                                r.stack
                            ].join(".");
    ...
    var Ni = bi.extend({
                ...
                ut.each(e.data.datasets, function (a, o) {
                    if (e.isDatasetVisible(o)) {
                        ...
                        ut.each(a.data, function (e, a) {
                            ...
                            isNaN(o) || r
                                .data[a]
                                .hidden || (i = Math.min(o, i), n = Math.max(o, n))
                        })
                    }
                }),
            ...
            convertTicksToLabels: function () {
                ...
                t.pointLabels = t
                    ...
                    .data
                    .labels
                    .map(t.options.pointLabels.callback, t)
            },
            getLabelForIndex: function (t, e) {
                return + this.getRightValue(this.chart.data.datasets[e].data[t])
            },
    ...
    function Ki(t, e) {
        ...
        null !== r
            ? +r
            : (
                a || "function" != typeof o || (r = o(e), ut.isFinite(r) || (r = i.parse(r))),
                r
            )
    }
    function Gi(t, e) {
    ...
    function $i(t, e, i, n) {
        ...
        for (
            ...
            a = g,
            c && d && !h && !s.round && (a = +o.startOf(a, d), a = +o.add(a, ~~ ((g - a) / (f.size * u)) * u, l)); a < p; a = +o.add(a, u, l)
        ) 
            m.push(+a);
        return m.push(+a),
        m
    ...
    var Ji = fi.extend({
            ...
            determineDataLimits: function () {
                ...
                c = Gi(r, d.max) || c,
                h = h === Hi
                    ? +l.startOf(Date.now(), u)
                    : h,
                c = c === Ei
                    ? +l.endOf(Date.now(), u) + 1
                    : c,
                r.min = Math.min(h, c),
                ...
                var e = this,
                    ...
                    a = (
                        i
                            ? (t - n) / i
                            : 0
                    ) * (e._offsets.start + 1 + e._offsets.start) - e._offsets.end,
        ...
        .override(
            "function" == typeof t
                ? {
                    ...
                    parse: function (e, i) {
                        return "string" == typeof e && "string" == typeof i
                            ? e = t(e, i)
    ...
    var un = {
            ...
            afterDatasetsUpdate: function (t, e) {
                ...
                for (n = 0; n < r; ++n) 
                    o = null,
                    (a = (i = t.getDatasetMeta(n)).dataset) && a._model && a instanceof Wt.Line && (
                        o = {
    ...
    st._set("global", {
        ...
        legendCallback: function (t) {
            ...
            for (var i = 0; i < t.data.datasets.length; i++) 
                e.push(
                    '<li><span style="background-color:' + t.data.datasets[i].backgroundColor + '">' +
                    '</span>'
                ),
                t
                    .data
                    .datasets[i]
                    .label && e.push(t.data.datasets[i].label),
                e.push("</li>");
            return e.push("</ul>"),
            e.join("")
        }
            ...
            if (e.display) {
                ...
                ut.each(t.legendItems, function (n, u) {
                    var h = d
                        ...
                        x = l.y;
                    p
                        ? u > 0 && b + v + i.padding > t.left + t.minSize.width && (
                            x = l.y += m,
                            l.line++,
                            b = l.x = t.left + (r - s[l.line]) / 2 + i.padding
                        )
                        : u > 0 && x + m > t.top + t.minSize.height && (
                    ...
                    function (t, i, n) {
                        if (!(isNaN(f) || f <= 0)) {
                            ...
                            if (
                                ...
                                ut
                                    .canvas
                                    .drawPoint(d, n.pointStyle, s, l, u)
                            } else 
            ...
            beforeUpdate: function (t) {
                ...
                e
                    ? (
                        ...
                        i
                            ? (ke.configure(t, i, e), i.options = e)
                            : pn(t, e)
                    )
    ...
    for (
        ...
        function () {
            ...
            ut.requestAnimFrame = "undefined" == typeof window
                ? function (t) {
                    t()
                }
            ...
            ut.getMaximumWidth = function (t) {
                ...
                var i = e.clientWidth,
                    n = i - ut._calculatePadding(e, "padding-left", i) - ut._calculatePadding(
                        e,
                        "padding-right",
                        i
                    ),
            ...
            ut.getMaximumHeight = function (t) {
                ...
                var i = e.clientHeight,
                    n = i - ut._calculatePadding(e, "padding-top", i) - ut._calculatePadding(
                        e,
                        "padding-bottom",
                        i
                    ),
            ...
            ut.longestText = function (t, e, i, n) {
                ...
                ut.each(i, function (e) {
                    null != e && !0 !== ut.isArray(e)
                        ...
                        : ut.isArray(e) && ut.each(e, function (e) {
            ...
            ut.measureText = function (t, e, i, n, a) {
                var o = e[a];
                return o || (o = e[a] = t.measureText(a).width, i.push(a)),
                o > n && (n = o),
                n
            },
